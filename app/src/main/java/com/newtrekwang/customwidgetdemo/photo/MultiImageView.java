...
import com.newtrekwang.customwidgetdemo.utils.DensityUtil;
...
//		Glide.with(getContext()).load(url).placeholder(R.drawable.user_logo).error(R.drawable.user_logo).diskCacheStrategy(DiskCacheStrategy.ALL).dontAnimate().into(imageView);
		return imageView;
	}
