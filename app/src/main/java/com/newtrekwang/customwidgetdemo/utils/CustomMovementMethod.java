...
public class CustomMovementMethod extends BaseMovementMethod {
    private final static int DEFAULT_COLOR =Color.parseColor("#00000000");
    private final static int DEFAULT_CLICKABLEA_COLOR = Color.parseColor("#ff9a9a9a");
    /**整个textView的背景色*/
    ...
    public CustomMovementMethod(){
        ...
        this.clickableSpanBgClor =DEFAULT_CLICKABLEA_COLOR;
    }
     ...
     */
    public CustomMovementMethod(int clickableSpanBgClor){
        this.clickableSpanBgClor = clickableSpanBgClor;
        this.textViewBgColor =DEFAULT_CLICKABLEA_COLOR;
    }
     ...
     */
    public CustomMovementMethod(int clickableSpanBgClor, int textViewBgColor){
